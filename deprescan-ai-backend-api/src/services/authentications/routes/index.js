...
router.post('/forgot-password', validate(forgotPasswordPayloadSchema), forgotPassword);

// GET /api/auth/reset-password/verify?token=xxx
router.get('/reset-password/verify', validateQuery(verifyResetTokenQuerySchema), verifyResetToken);

// POST /api/auth/reset-password
router.post('/reset-password', validate(resetPasswordPayloadSchema), resetPassword);
